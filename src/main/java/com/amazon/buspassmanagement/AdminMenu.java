...
public class AdminMenu extends Menu{
	...
	public void showMenu() {
		...
		if(result && adminUser.type == 1) {
			...
			adminUser = userDAO.retrieveUser("SELECT * FROM User WHERE email='"+adminUser.email+"' AND password = '"+adminUser.password+"';");
			...
			while(true) {
	        	...
	        	switch (choice) {
					...
					case 4:
						...
						System.out.println("5: View Expired Passes");
						System.out.println("6: View Passes Within Date Range");
						System.out.println("Enter Your Choice: ");
						...
						if(passChoice == 1) {
							...
							System.out.println("Enter Dates in yyyy-mm-dd format");
							System.out.println("Enter From Date (Inclusive): ");
							String fromDate = scanner.nextLine();
							System.out.println("Enter To Date (Exclusive): ");
							String toDate = scanner.nextLine();
							passService.viewPassWithinRange(fromDate, toDate);
						}else {
